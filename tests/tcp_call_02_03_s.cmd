...
..\win32_vs15\Debug\srtp_decoder.exe %PCAP_FILENAME_A%.pcap %PCAP_FILENAME_A%.opus %SSRC_A% %SSTP_A% %ALG% true 2>&1 >%PCAP_FILENAME_A%.log
..\win32_vs15\Debug\srtp_decoder.exe %PCAP_FILENAME_B%.pcap %PCAP_FILENAME_B%.opus %SSRC_B% %SSTP_B% %ALG% true 2>&1 >%PCAP_FILENAME_B%.log
